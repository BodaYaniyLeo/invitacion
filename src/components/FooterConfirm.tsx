...
export const FooterConfirm = ({
    ...
    return (
        <div id="containerConfirm" ref={containerRef} className="px-6 pointer-events-auto py-2 justify-items-center w-full bg-[#111117] content-center mb-10 my-5 max-w-[1000px] lg:justify-self-center">
                                ...
                                <div className='flex justify-between items-center gap-4'>
                                    ...
                                    <div className='flex'>
                                        ...
                                        <button onClick={() => setVisibleOptions(prev => prev === g.id ? null : g.id)}>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 12 12" className={`min-w-6 duration-500 ms-1 ${g.confirm ? "opacity-100" : "opacity-10"} ${g.confirm && visibleOptions === g.id ? "-rotate-180" : "rotate-0"}`}>
