...
export const Intro = () => {
    return (
        ...
        >
            <div id='textOrg' className='flex flex-col h-[110dvh] justify-center scale-115 mx-4 max-w-[1000px] lg:justify-self-center '>
                <div id='textOrgInner'>
                    <h2 className='text-(length:--h2size)'>Córdoba,<br />Argentina</h2>
