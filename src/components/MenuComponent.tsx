...
export const MenuComponent = ({
    ...
    return (
        ...
        >
            <div className='bg-[#111117FC] flex flex-col items-center h-dvh p-[3dvh] w-fit justify-self-end justify-between relative'>
                ...
                <div className='flex uppercase justify-between w-full'>
                    <div>
                        <a onClick={() => setOpenMenu(false)} href={urlMaps} target='_blank' className='flex items-center text-[length:var(--menusize)] mb-3 text-white'>
                            <Image
                                src={menu}
                                alt=""
