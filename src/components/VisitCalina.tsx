...
export const VisitCalina = ({
    ...
    return (
        <div
            id={id}
            className="flex flex-col justify-center items-center relative -scroll-mt-[5dvh]"
        >
            <div className='z-11'>
                <div className='flex flex-col items-center justify-end h-[75dvh] lg:h-[100dvh]'>
                ...
                <div id='photoSalon' className="pointer-events-auto flex flex-col items-center justify-between h-[120dvh] lg:h-auto">
                    <button
