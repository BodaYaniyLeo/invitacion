            ...
            <div className="relative w-full h-lvh overflow-hidden">
                <div id="heroMask" className="absolute inset-0 z-30 pointer-events-none h-lvh">
                    <picture id='heroComplete' className='flex h-lvh w-vw scale-125 object-cover justify-center relative'>
                        <Image src={backHero} alt="" className='h-lvh w-auto object-cover z-1' />
                        <Image src={frontHero} alt="" className='h-lvh w-auto absolute top-0 left-0 object-cover z-3 top-1/2 left-1/2 -translate-1/2' />
                        <Image src={textHero} alt="" className='absolute z-2 top-1/3 -translate-y-1/2 -translate-1/10 w-[80vw] max-h-1/4' loading='eager' id='imgTextHero' />
                    </picture>
                </div>

                <div id='dateLogo' className="absolute h-lvh w-full inset-0 z-20 opacity-0 flex flex-col items-center justify-center text-white p-6 top-1/2 left-1/2">
